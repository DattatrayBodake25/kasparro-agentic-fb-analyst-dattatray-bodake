...
This document explains the **multi-agent architecture** behind the *Agentic Facebook Performance Analyst* system.  
The system autonomously diagnoses **ROAS fluctuations**, identifies performance drivers, and generates **data-driven creative recommendations** using structured reasoning and modular agent interactions.
